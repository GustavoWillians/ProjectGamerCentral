...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleSignIn() async {
    ...
    try {
      ...
      // CORREÇÃO: Não navegamos para o Dashboard. Apenas fechamos a tela de login.
      // O AuthGate tratará do resto.
      if (mounted) {
        // Esta linha pode ser removida, pois o AuthGate já fará a transição.
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Sua jornada gamer, decodificada.', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Mona Sans', fontSize: 18, color: Colors.white70)),
